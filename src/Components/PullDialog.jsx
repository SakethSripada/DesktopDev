...
function PullDialog({ open, onClose, repoTabs, currentTab, handleRepoInputChange, handlePull }) {
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle style={{ color: 'white', backgroundColor: '#333' }}>Pull Changes - {repoTabs[currentTab].name}</DialogTitle>
      ...
      <DialogActions style={{ backgroundColor: '#333' }}>
        ...
        <Button onClick={handlePull} color="primary">Pull</Button>
      </DialogActions>
    </Dialog>
  );
}
